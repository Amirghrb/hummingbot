...
class XtAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = XtExchange(
            ...
            xt_api_secret="0fb85c3278a1afa288a028d49eab412643ca068c",
            trading_pairs=["btc_usdt","eth_btc","trx_usdt"],
            trading_required=False,
            domain=self.domain)
        self.data_source = XtAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.xt.xt_api_order_book_data_source"
           ".XtAPIOrderBookDataSource._sleep")
